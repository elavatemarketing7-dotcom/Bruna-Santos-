...
const App: React.FC = () => {
  ...
  // Quiz View Component
  const QuizView = () => (
    <div className="fixed inset-0 z-50 bg-[#0f1c14] flex flex-col items-center justify-center px-6 overflow-y-auto py-10">
      ...
      <div className="w-full max-w-md bg-white rounded-[2.5rem] p-8 shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="space-y-3 text-center">
          <span className="text-gold font-bold text-[10px] tracking-widest uppercase bg-gold/5 px-3 py-1 rounded-full">Pergunta {quizStep + 1} de {QUIZ_QUESTIONS.length}</span>
        ...
        <div className="grid gap-3">
          {QUIZ_QUESTIONS[quizStep].options.map((option, idx) => (
            <button
              ...
              className="w-full py-4 px-6 text-left rounded-2xl border-2 border-gray-100 hover:border-gold hover:bg-gold/5 transition-all text-gray-700 font-medium active:scale-95 flex items-center justify-between group"
            >
              {option}
        ...
        <button 
          ...
          className="text-gray-400 text-sm font-medium w-full text-center hover:text-gray-600 transition-colors pt-2"
        >
    ...
    <div className="fixed inset-0 z-50 bg-[#0f1c14] overflow-y-auto overflow-x-hidden">
      <div className="min-h-screen flex flex-col items-center justify-center p-6 space-y-8 max-md mx-auto text-center">
        ...
        <div className="space-y-4">
          <div className="bg-gold/20 text-gold border border-gold/30 px-4 py-1 rounded-full inline-block text-sm font-bold tracking-widest uppercase">
            Perfil Compatível
          </div>
          <h1 className="text-white text-4xl heading-serif leading-tight">Você é a Paciente Ideal</h1>
        ...
        <div className="w-full space-y-4 pt-4">
          <button 
            ...
            className="w-full bg-gold text-white py-5 rounded-2xl font-bold shadow-lg shadow-gold/20 flex items-center justify-center gap-3 animate-pulse active:scale-95 transition-transform"
          >
          ...
          <button 
            ...
            className="w-full bg-white/10 text-white border border-white/20 py-5 rounded-2xl font-bold flex items-center justify-center gap-3 active:scale-95 transition-transform"
          >
            CHAMAR NO WHATSAPP
          </button>
  ...
  const InitialChoice = () => (
    <div className="fixed inset-0 z-[60] bg-premium flex flex-col items-center justify-center p-6 space-y-8 text-center overflow-y-auto">
      <div className="relative group">
        ...
        <div className="relative w-40 h-40 rounded-full overflow-hidden border-2 border-gold shadow-2xl animate-float">
          <img src={IMAGES.hero} alt={EXPERT.name} className="w-full h-full object-cover" />
        </div>
      </div>

      <div className="space-y-2">
        <h1 className="text-white text-5xl heading-serif italic">{EXPERT.name}</h1>
        <p className="text-gold tracking-[0.3em] uppercase text-[10px] font-bold">Harmonização Facial de 💚</p>
      </div>
      ...
      <div className="w-full max-w-sm space-y-4 pt-4">
        <button 
          ...
          className="w-full bg-gold text-white py-6 rounded-2xl font-bold text-lg shadow-2xl shadow-gold/20 flex items-center justify-center gap-4 group active:scale-95 transition-all"
        >
        ...
        <button 
          onClick={() => setView(ViewState.MAIN)}
          className="w-full bg-white/5 border border-white/10 text-white py-6 rounded-2xl font-medium text-lg hover:bg-white/10 transition-all active:scale-95"
        >
          IR DIRETO PARA O SITE
        </button>
      </div>
      
      <p className="text-white/30 text-[10px] font-light tracking-[0.2em] uppercase mt-4">Exclusividade em cada detalhe.</p>
    </div>
  );
    ...
    <div className="relative">
          ...
          <div className="max-w-2xl space-y-8 bg-gradient-to-t from-[#0f1c14]/40 to-transparent p-4 rounded-3xl backdrop-blur-[2px] sm:backdrop-blur-0 sm:bg-none">
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-3">
                ...
                <h2 className="text-gold tracking-[0.6em] uppercase text-sm sm:text-base font-black drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
            ...
            <p className="text-white text-xl sm:text-3xl font-light leading-tight sm:leading-relaxed max-w-xl drop-shadow-[0_2px_2px_rgba(0,0,0,0.9)]">
            ...
            <div className="pt-8 space-y-6">
              <button 
                onClick={() => openWhatsApp(false)}
                className="w-full sm:w-auto px-12 py-6 bg-gold text-white rounded-full font-extrabold text-xl flex items-center justify-center gap-4 shadow-[0_20px_50px_rgba(197,160,89,0.3)] hover:scale-105 active:scale-95 transition-all"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative group">
              ...
              <img src={IMAGES.authority1} alt="Dra Bruna Santos em atendimento" className="relative rounded-2xl shadow-2xl w-full h-[500px] object-cover" />
            </div>
            <div className="space-y-8">
              <div className="space-y-4">
                <span className="text-gold font-bold tracking-[0.2em] uppercase text-sm">Autoridade em Harmonização</span>
                <h2 className="text-4xl heading-serif leading-tight">Uma jornada focada no <span className="italic">atendimento humanizado.</span></h2>
              ...
              <button 
                onClick={() => openWhatsApp(false)}
                className="inline-flex items-center gap-2 text-gold font-bold text-lg hover:translate-x-2 transition-transform"
              >
      ...
      <section className="py-24 bg-[#f8f5f0]">
        <div className="container mx-auto px-6 text-center mb-12">
          <h2 className="text-4xl heading-serif mb-4">Resultados Reais</h2>
          <p className="text-gray-500 max-w-lg mx-auto italic">Veja algumas das transformações realizadas em nosso consultório.</p>
        </div>
        ...
        <div className="px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 max-w-7xl mx-auto">
            {IMAGES.gallery.map((img, i) => (
              <div 
                key={i} 
                className="aspect-[4/5] overflow-hidden rounded-xl cursor-pointer hover:opacity-90 transition-opacity"
          ...
          <p className="text-center text-gray-400 text-xs mt-8">* Resultados podem variar de pessoa para pessoa. Cada organismo responde de forma única.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl heading-serif mb-4">Por que confiar em mim?</h2>
            <div className="w-24 h-1 bg-gold mx-auto"></div>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {DIFFERENTIALS.map((card, i) => (
              <div key={i} className="bg-[#fcfaf7] p-8 rounded-3xl border border-gold/5 hover:border-gold/20 hover:shadow-xl transition-all group">
      ...
      <section className="py-16 px-6">
        <div className="bg-premium rounded-[3rem] p-12 text-center space-y-8 max-w-5xl mx-auto shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-gold/10 blur-[100px] rounded-full"></div>
          <h2 className="text-3xl text-white heading-serif italic">Pronta para viver essa experiência?</h2>
          <p className="text-white/70 max-w-lg mx-auto font-light">Sua jornada para a autoconfiança começa com um simples clique. Vamos conversar?</p>
          <button 
            onClick={() => openWhatsApp(false)}
            className="px-12 py-5 bg-gold text-white rounded-full font-bold shadow-xl shadow-gold/20 active:scale-95 transition-all"
          >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl heading-serif">Como funciona a primeira consulta</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="text-center space-y-4">
                <div className="text-gold/20 text-7xl font-bold leading-none select-none">{item.step}</div>
                <h3 className="text-xl font-bold">{item.title}</h3>
                <p className="text-gray-500 font-light px-4">{item.desc}</p>
              </div>
            ))}
          </div>
          <p className="text-center text-gold font-bold mt-16 italic uppercase tracking-widest text-sm">Agendamento rápido e prático.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#f8f5f0] overflow-hidden">
        <div className="container mx-auto px-6 mb-12">
          <h2 className="text-4xl heading-serif italic">Bastidores & Atendimento</h2>
        </div>
        <div className="flex gap-4 overflow-x-auto px-6 scrollbar-hide">
          {IMAGES.lifestyle.map((img, i) => (
            <div key={i} className="flex-shrink-0 w-72 h-96 rounded-3xl overflow-hidden shadow-lg group relative">
               ...
               <div className="absolute bottom-6 left-6 text-white font-medium italic">Atendimento exclusivo</div>
            </div>
          ))}
      ...
      <section className="py-32 bg-white px-6">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <h2 className="text-5xl sm:text-7xl heading-serif leading-tight">
          ...
          <div className="space-y-6 pt-6">
            <button 
              onClick={() => openWhatsApp(false)}
              className="w-full sm:w-auto px-16 py-6 bg-premium text-white rounded-full font-bold text-xl shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-4 mx-auto"
            >
              <Calendar className="w-6 h-6 text-gold" />
              Agendar consulta no WhatsApp
            </button>
            <p className="text-gold font-bold uppercase tracking-widest text-sm">Vagas limitadas para este mês</p>
          </div>
        </div>
      </section>
      ...
      <footer className="py-16 bg-[#0f1c14] text-white/80 text-center px-6">
        <div className="container mx-auto space-y-10">
          <div className="space-y-2">
            <h3 className="signature text-5xl text-gold">{EXPERT.name}</h3>
            <p className="uppercase tracking-[0.3em] text-[10px] text-white/40">{EXPERT.profession}</p>
          </div>
          
          <div className="flex flex-col items-center space-y-4">
            <a href={EXPERT.instagram} target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-gold transition-colors">
          ...
          <div className="pt-10 border-t border-white/5 text-[10px] uppercase tracking-widest text-white/20">
